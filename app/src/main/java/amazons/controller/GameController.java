...
public class GameController {
    ...
    private PlayerID checkForLosers(){
        System.out.println("Checking for losers.");
        AbstractPlayer player = (AbstractPlayer) getCurrentPlayer();
        AbstractPlayer opponentPlayer = (AbstractPlayer) getOpponentPlayer();
        System.out.println("player.hasPlayableAmazons(): "+ player.hasPlayableAmazons());
        System.out.println("opponentPlayer.hasPlayableAmazons(): "+ opponentPlayer.hasPlayableAmazons());
